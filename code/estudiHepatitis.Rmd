...
Podem veure com utilitzant simplement els atributs quantitatius obtenim un model bastant bo amb un AUC de 0.849.
```{r}
...
summary(log.qual)
```
Obtenim un AUC molt elevat 0.921.
```{r}
