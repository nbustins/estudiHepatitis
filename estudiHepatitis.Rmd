...
En aquest apartat intentarem descobrir quines variables qualitatives influeixen més sobre si el pacient viurà o morirà. Utilitzarem el test de chi quadrat.

```{r}
library("ggplot2")
```

Aplicarem el test a totes les variables categòriques.
```{r}
mat <- NULL
alpha <- 0.05
for (atr in catattrs){
